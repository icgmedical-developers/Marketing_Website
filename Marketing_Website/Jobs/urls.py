...
from .views import Homepage, Extract_Data_From_XML, ShowJobs, job_detail, ShowJob_Category
...
urlpatterns = [
    ...
    path('show-jobs/<str:category>/', ShowJob_Category, name='ShowJob_Category'),
]
